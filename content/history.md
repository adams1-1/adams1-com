---
title: "A Short History of Bar Code - From Invention to Today"
...
The railroad industry made the first serious attempt at standardized implementation with <a href="https://www.railwayage.com/mechanical/freight-cars/whatever-happened-to-kartrak/" rel="nofollow">KarTrak ACI</a> (Automatic Car Identification) in the late 1960s. Colored stripes on the sides of railcars encoded car ownership and type. The system failed spectacularly due to dirt, paint chipping, and harsh weather conditions. Optical systems require clean surfaces, and railcars in active service don't stay clean.

The grocery industry learned from these failures. In 1973, the Uniform Grocery Product Code Council (now GS1 US) selected the Universal Product Code as the industry standard. IBM's George Laurer designed the [UPC symbology](/upccode.html), which refined Woodland's linear concept into a practical 12-digit format with built-in error detection. The modulo-10 check digit meant single character errors would be caught before incorrect data entered inventory systems.
